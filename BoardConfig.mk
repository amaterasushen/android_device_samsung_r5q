...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/r5q/prebuilt/Image.gz-dtb
TARGET_PREBUILT_DTB := device/samsung/r5q/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/r5q/prebuilt/recoverydtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPSG08A004"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/r5q/bootimg.mk
...
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 7409319936
